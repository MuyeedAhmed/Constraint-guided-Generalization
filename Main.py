...
if __name__ == "__main__":
    ...
    if len(sys.argv) <= 3:
        print("Usage: python STC.py <Method> <Dataset_Name> <Save_Checkpoint(Y/N)> <Misclassification_Count> <CMC_Type>")
        sys.exit(1)
    method = sys.argv[1]
    ...
    with open(csv_path, "a", newline="") as f:
        writer = csv.DictWriter(f, fieldnames=["Dataset","Run","Checkpoint","Method","CMC_Type","Misclassification_Count",
